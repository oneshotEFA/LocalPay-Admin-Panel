...
import {
  LayoutDashboard, KeyRound, Building2, Receipt,
  Download, ArrowRightLeft, Settings, LogOut,
} from "lucide-react";
    ...
    <aside className={cn(
      ...
      <div className="h-16 px-5 flex items-center justify-between border-b border-slate-100 flex-shrink-0">
        <div className="flex items-center gap-2.5">
          ...
          <div>
            <p className="text-sm font-semibold text-slate-900 leading-none">HabeshaUnlocker</p>
            <p className="text-[10px] text-slate-400 uppercase tracking-widest mt-0.5">Client Portal</p>
          </div>
        </div>
        {isMobile && (
